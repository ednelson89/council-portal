<template>
  <div>
    ...
    <b-row>
      <b-col>
        <p>
          Here you can view and edit the characters in the game. To add a
          character, you must have joined the game or be the game's GM.
        </p>
      </b-col>
    </b-row>
    <b-row>
      <b-col cols="2">
        <b-button class="cardButton" @click="setAppRoute" :disabled="!inGame"
          >Add a Character</b-button
        >
      </b-col>
    </b-row>
    <hr />
    ...
    ></ChangelingPreview>
    <SR5Preview v-if="activeGame.gameType === 'SR5'"></SR5Preview>
  </div>
</template>
...
import SR5Preview from '@/components/views/CampaignModules/CharacterPreviews/PreviewSR5.vue';
