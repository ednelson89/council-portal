        ...
        <b-card class="b-cards">
          <b-row>
            <b-col cols="3">
              ...
              <label>
                Virtue:
                <input class="form-control" v-model="char.genBlock.virtue" />
              </label>
              <label>
                Vice:
                <input class="form-control" v-model="char.genBlock.vice" />
              </label>
              <label>
                Concept:
            ...
            <b-col cols="3">
              ...
              <label>
                Faction:
                <input class="form-control" v-model="char.genBlock.faction" />
              </label>
              <label>
                Group Name:
                <input class="form-control" v-model="char.genBlock.groupName" />
              </label>
            </b-col>
...
export default {
  ...
  methods: {
    // The Following all parse the individual textAreas and lists
    saveBackstory() {
      this.char.backstory = [];
    ...
    addCondition() {
      this.char.combatStats.conditions.push(this.tempCond);
    },
    delCondition(index) {
