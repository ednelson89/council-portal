<template>
  <div>
    ...
    <b-tabs content-class="mt-3">
            ...
            <b-card class="b-cards">
              ...
              <b-row>
                ...
                <b-col>
                  ...
                  <select class="form-control codSelect" v-model="tempChar.combatStats.wyrd">
                    <option v-for="(num, index) in willInteg" :key="index" :value="num">{{ num }}</option>
                  </select>
                </b-col>
                <b-col>
                  <label class="inline-label">Glamour:</label>
                  <select class="form-control codSelect" v-model="tempChar.combatStats.glamour">
                    <option v-for="(num, index) in glamInteg" :key="index" :value="num">{{ num }}</option>
                  </select>
                </b-col>
                <b-col>
                  <label class="inline-label">Clarity:</label>
                  <select class="form-control codSelect" v-model="tempChar.combatStats.clarity">
                    <option v-for="(num, index) in willInteg" :key="index" :value="num">{{ num }}</option>
                  </select>
                </b-col>
              </b-row>
      ...
      <b-tab :title="'Contracts & Pledges'"></b-tab>
      <b-tab :title="'Expanded Merits'"></b-tab>
      <b-tab :title="'Other Traits'"></b-tab>
